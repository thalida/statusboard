...
DERIVED = {
    ...
    "Status.last_refreshed_at":           "component.service.poll_schedule.last_success_at",
    "StatusPage.poll_interval_seconds":         "service.poll_schedule.interval_seconds or /meta/ default, scaled by backoff",
    "StatusPage.poll_cooldown_seconds":         "service.poll_schedule.cooldown_seconds or /meta/ default",
    "StatusPage.poll_last_success_at":          "service.poll_schedule.last_success_at",
    "StatusPage.poll_next_at":                  "service.poll_schedule.next_at",
    "StatusPage.poll_consecutive_failure_count":"service.poll_schedule.consecutive_failure_count",
